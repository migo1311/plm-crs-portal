...
class LivewireTudyPlan extends Component
{
    use WithPagination;
    ...
    public function viewStudentDetails($id)
    {
        ...
        $this->view_student_name = $student->lastname;
